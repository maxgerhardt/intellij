...
public final class UnpackedAarUtils {
  ...
  /**
   * Returns aar directory name without extension in the format of name_hashcode. This provides
   * flexibility to caller to generate aar directory name to deal with different cases. But this
   * method cannot guarantee the uniqueness.
   *
